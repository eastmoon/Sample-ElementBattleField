...
*/
package section.DEMO.Module.Demo.Space.pattern
{
	/*import*/
	/*import：Flash內建元件庫*/
	...
	public dynamic class GeometrySpace extends RMSpace
	{
		...
		/*constructor：建構值*/
		public function GeometrySpace( a_width : Number, a_height : Number ) : void
		{
			// 初始空間資料
			super( new RMSpaceVar( 0, 0, 0, a_width, a_height, 0 ) );
			// 登記事件
		...
		private function NotifyActorUpdate( a_notification : IRMNotification ) : void
		{
			...
			// 2. Focus Actor
			// 2.1 取回 Avator Actor
			var avator : AvatorActor = this.getModule().RetrieveActor( AvatorActor.NAME ) as AvatorActor;
			// 2.2 計算空間內角色
